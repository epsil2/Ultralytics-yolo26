...
This guide explains how to export Ultralytics YOLO models to ExportedProgram (PT2) format.

## When to Use PT2

PT2 is useful when you need:
...
## Exporting YOLO Models to PT2

### Installation

No extra dependencies beyond PyTorch are required:
...
!!! example "Usage"
    ...
    === "Python"
        ...
        model.export(format="pt2")  # creates 'yolo11n.pt2'
        ```

    === "CLI"

        ```bash
        yolo export model=yolo11n.pt format=pt2  # creates 'yolo11n.pt2'
        ```
...
### How does PT2 differ from TorchScript?
